...
- **El Contrato es la Ley (Spec-Driven Development)** — Ningún endpoint se programa, ni ninguna validación de payload se escribe a mano, sin antes haber definido y aprobado el contrato `openapi.yaml`. Esto asegura fiabilidad, pruebas automatizadas y aislamiento entre capas.
